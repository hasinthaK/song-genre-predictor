package lk.ac.mrt.cse.spark.kusala248201v.service.transformer;

import lk.ac.mrt.cse.spark.kusala248201v.constant.Column;
import lk.ac.mrt.cse.spark.kusala248201v.util.StemmingFunction;
...
public class Stemmer extends Transformer implements MLWritable {
    ...
    public Dataset<Row> transform(Dataset dataset) {
        return dataset.map(new StemmingFunction(), RowEncoder.encoderFor(this.transformSchema(dataset.schema())));
    }
